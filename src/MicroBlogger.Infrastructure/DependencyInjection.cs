...
using MicroBlogger.Infrastructure.Persistence.Seed;
using MicroBlogger.Infrastructure.Persistence;
using Microsoft.EntityFrameworkCore.Diagnostics;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using MicroBlogger.Infrastructure.Persistence.Interceptors;
...
namespace MicroBlogger.Infrastructure;
...
public static class DependencyInjection
{
    ...
    private const string MSSQL_MIGRATIONS_ASSEMBLY = "MicroBlogger.Migrators.MSSQL";
    private const string SQLITE_MIGRATIONS_ASSEMBLY = "MicroBlogger.Migrators.SQLite";
    private const string POSTGRESQL_MIGRATIONS_ASSEMBLY = "MicroBlogger.Migrators.PostgreSQL";
    private const string USE_IN_MEMORY_DATABASE_KEY = "UseInMemoryDatabase";
    private const string IN_MEMORY_DATABASE_NAME = "MicroBloggerDb";
