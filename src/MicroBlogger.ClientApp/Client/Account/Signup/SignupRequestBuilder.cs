...
using System;
namespace MicroBlogger.Api.Client.Account.Signup
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::MicroBlogger.Api.Client.Account.Signup.SignupRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(global::MicroBlogger.Api.Client.Models.SignupRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(global::MicroBlogger.Api.Client.Models.SignupRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::MicroBlogger.Api.Client.Models.SignupRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::MicroBlogger.Api.Client.Models.SignupRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::MicroBlogger.Api.Client.Account.Signup.SignupRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::MicroBlogger.Api.Client.Account.Signup.SignupRequestBuilder WithUrl(string rawUrl)
        {
            return new global::MicroBlogger.Api.Client.Account.Signup.SignupRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
