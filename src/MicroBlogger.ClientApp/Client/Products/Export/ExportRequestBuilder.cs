...
using System;
namespace MicroBlogger.Api.Client.Products.Export
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::MicroBlogger.Api.Client.Products.Export.ExportRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::MicroBlogger.Api.Client.Products.Export.ExportRequestBuilder.ExportRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::MicroBlogger.Api.Client.Products.Export.ExportRequestBuilder.ExportRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::MicroBlogger.Api.Client.Products.Export.ExportRequestBuilder.ExportRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::MicroBlogger.Api.Client.Products.Export.ExportRequestBuilder.ExportRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::MicroBlogger.Api.Client.Products.Export.ExportRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::MicroBlogger.Api.Client.Products.Export.ExportRequestBuilder WithUrl(string rawUrl)
        {
            return new global::MicroBlogger.Api.Client.Products.Export.ExportRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Exports the product data to a CSV file based on the provided keywords. The CSV file includes product details such as ID, name, description, price, SKU, and category.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ExportRequestBuilderGetRequestConfiguration : RequestConfiguration<global::MicroBlogger.Api.Client.Products.Export.ExportRequestBuilder.ExportRequestBuilderGetQueryParameters>
        {
        }
    }
}
